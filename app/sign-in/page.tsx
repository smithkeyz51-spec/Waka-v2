          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border-2 border-[#1A1A1A]/10 pl-3 pr-10 py-2.5 text-sm focus:border-[#F7C548] outline-none bg-white"
              />
              <button
                type="button"
                onClick={() => setShowPassword((v) => !v)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#1A1A1A]/40"
